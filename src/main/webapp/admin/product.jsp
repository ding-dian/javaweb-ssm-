...
<div id="brall">
    ...
    <div id="condition" style="text-align: center">
        <form id="myform">
            文章名称：<input name="pname" id="pname">&nbsp;&nbsp;&nbsp;
            文章标签：<select name="typeid" id="typeid">
            <option value="-1">请选择</option>
            <c:forEach items="${typeList}" var="pt">
                <option value="${pt.typeId}">${pt.typeName}</option>
            </c:forEach>
        </select>&nbsp;&nbsp;&nbsp;
            点赞数：<input name="lprice" id="lprice">-<input name="hprice" id="hprice">
            ...
            <c:when test="${info.list.size()!=0}">
                ...
                <div id="middle" >
                    <table class="table table-bordered table-striped" <%--style="table-layout:fixed"--%>>
                        <tr>
                            <th></th>
                            <th style="text-align:center;vertical-align:middle;">文章名字</th>
                            <th style="text-align:center;vertical-align:middle;">文章内容</th>
                            <th style="text-align:center;vertical-align:middle;">文章图片</th>
                        ...
                        <c:forEach items="${info.list}" var="p">
                            <tr>
                                ...
                                <td>${p.pName}</td>
                                <%--<td><div >${p.pContent}</div></td>--%>
                                <td <%--style="word-wrap:break-word;"--%>width="60%" height="70">
               ...
               // alert("可以进行删除!");
                ...
                $.ajax({
                    ...
                    success:function (msg) {
                        ...
                        $("#table").load("http://120.77.32.127:8080/webssm/admin/product.jsp #table");
                    }
                });
            }
        }
